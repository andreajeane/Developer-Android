package id.ac.poliban.mi.andrea.notifymechallenge_andrea;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION =
            id.ac.poliban.mi.andrea.notifymechallenge_andrea.BuildConfig.APPLICATION_ID + ".ACTION_CANCEL_NOTIFICATION";
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.andrea.notifymechallenge_andrea.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMeChallenge_Andrea");
